...
## Portfolio continuous-execution override
...
Preserve unrelated edits, external permission boundaries, and truthful check/commit reporting.
Do not push, publicly publish, discard edits, invent personal details, or change external sharing permissions as an inferred implementation step.
This override applies only to the portfolio scope and does not authorize unrelated redesign.
